...
1) Trigonometric functions (at least sines, cosines and tangents).
2) Keyword to print a list of current variables, constants and their respective values.
3) Suggestions when the user has made a mistake (e.g.: did you mean "x"?)

I will implement option 2, using the keyword "list".
...
void print_help()
{
	std::cout <<"-INSTRUCTIONS-\nEnter an arithmetical expression (or several followed by ; each) to compute its results.\n"
