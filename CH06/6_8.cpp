...
overreliance on comments); it does not define sequences of statements,such as 4+4; 5+6;, 
and it does not incorporate the grammar changes
...
Besides sequences of statements, I've been updating the grammar with the changes I made.
